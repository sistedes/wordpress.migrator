...
public class Collection extends AbstractDSpaceEntity {
	...
	public static Collection from(Community community, Track track) {
		...
		return new Collection(track.getTitle(), track.getDescription(), community.getUri(), suffix);
	}

	public Collection(String title, String description, String baseUri, String suffix) {
		this.name = title;
