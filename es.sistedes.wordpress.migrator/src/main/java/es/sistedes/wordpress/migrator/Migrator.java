...
public class Migrator {
	...
	private Collection createCollection(final Community parent, final Edition edition) throws MigrationException, IOException, ParseException, URISyntaxException {
		String name = "Art�culos";
		String _abstract = "Art�culos publicados en las " + edition.getProceedingsName() + ".";
	...
	private Collection createPreliminariesCollection(final Community parent) throws Exception {
		...
		String _abstract = "Preliminares de las Actas de las " + parent.getName() + ". "
				+ "Los preliminares de las actas incluyen informaci�n adicional sobre las jornadas, "
				+ "tales como la presentaci�n de las jornadas, los comit�s participantes, "
	...
	private Collection createBulletinsCollection(final Community parent) throws Exception {
		...
		String _abstract = "El Bolet�n informativo de Sistedes es, en la actualidad, una publicaci�n trimestral "
				+ "que recopila noticias recientes y relevantes, tanto para los socios como para todo aquel que "
				+ "pueda estar interesado en la Asociaci�n. En los boletines se recogen tanto las noticias de "
				+ "los hechos acaecidos en el periodo correspondiente, como aquellas de inter�s que vayan a suceder "
				+ "pr�ximamente";
		String description = "El Bolet�n informativo de Sistedes es, en la actualidad, una publicaci�n trimestral "
				+ "que recopila noticias recientes y relevantes, tanto para los socios como para todo aquel que "
				+ "pueda estar interesado en la Asociaci�n. En los boletines se recogen tanto las noticias de "
				+ "los hechos acaecidos en el periodo correspondiente, como aquellas de inter�s que vayan a suceder "
				+ "pr�ximamente (congresos organizados por los socios, cursos, seminarios, tesis le�das, premios, etc.). "
				+ "Los Corresponsales de Sistedes colaboran con la directiva de la asociaci�n proporcionando el "
				+ "contenido de los boletines. Si usted desea contribuir a los mismos, puede contactar con los "
				+ "editores enviando un mensaje de correo electr�nico a la direcci�n "
	...
	private Collection createSeminarsCollection(final Community parent) throws Exception {
		...
		String _abstract = "Los Seminarios Sistedes son charlas sobre temas de inter�s para nuestra comunidad cient�fica,"
				+ " impartidos por destacados miembros de la misma y/o reconocidos expertos en las materias objeto de los mismos.";
		String description = "Los Seminarios Sistedes son charlas sobre temas de inter�s para nuestra comunidad cient�fica,"
				+ " impartidos por destacados miembros de la misma y/o reconocidos expertos en las materias objeto de los mismos.";
